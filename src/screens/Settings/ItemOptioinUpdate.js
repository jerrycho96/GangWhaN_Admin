...
export default function ItemOptioinUpdate() {
  // 모달 상태관리 훅
      ...
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        <View
          ...
          <View
            ...
            <Text style={styles.boldtxt18}>옵션 추가</Text>
            <TouchableOpacity
              onPress={() => {
                Cancel();
              }}>
          ...
          <View style={{flexDirection: 'row', width: '100%', marginTop: 20}}>
            <TouchableOpacity
              ...
              <Text style={styles.boldwhite16}>옵션 등록</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
      ...
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        <View
          ...
          <View
            ...
            <Text style={styles.boldtxt18}>옵션 삭제</Text>
            <TouchableOpacity
              onPress={() => {
                Cancel();
              }}>
          ...
          <View style={{flexDirection: 'row', width: '100%', marginTop: 20}}>
            <TouchableOpacity
              ...
              <Text style={styles.boldwhite16}>옵션 삭제</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
